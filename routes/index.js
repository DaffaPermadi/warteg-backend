    ...
    // Order routes
    route.get('/api/order/history', authentication, TransactionController.getTransactionHistory);
    route.get('/api/order/:id', authentication, TransactionController.getTransactionHistoryById);
